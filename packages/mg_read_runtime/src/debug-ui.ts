...
(() => {
  ...
  async function openContent(pluginId, book, chapter) {
    ...
    try {
      ...
      const body = document.createElement('pre'); body.textContent = content.text || '当前内容不是小说正文，或数据源未返回文本。';
