...
void main() {
  ...
  testWidgets('Android Runtime installs ADB-delivered plugin archives', (
    ...
    final fixtureDetail = await runtime.invoke(
    ...
    final fixtureChapters = await runtime.invoke(
    ...
    expect(
      fixtureChapters.items.map((chapter) => chapter.id).toSet(),
      hasLength(733),
    );
    expect(
