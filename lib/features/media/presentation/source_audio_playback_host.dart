...
final class _ActiveSourceAudioPlaybackHostState extends ConsumerState<_ActiveSourceAudioPlaybackHost> {
  ...
  Widget _buildExitPrompt(BuildContext context) {
    return Stack(
      fit: StackFit.expand,
      children: <Widget>[
        const ModalBarrier(key: Key('audio-background-exit-barrier'), dismissible: false, color: Colors.black54),
        SafeArea(
          child: Center(
            child: AlertDialog(
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        ...
        boxShadow: <BoxShadow>[BoxShadow(color: tokens.shadow.withValues(alpha: 0.12), blurRadius: 20, offset: const Offset(0, 8))],
      ),
      child: ClipRRect(
        borderRadius: AppRadii.detailControl,
                        ...
                        child: SizedBox.square(
                          ...
                          child: Tooltip(
                            ...
                            child: Icon(
                              ...
                              color: failure == null ? tokens.accent : tokens.warning,
                            ),
                          ),
                        ),
                      ),
