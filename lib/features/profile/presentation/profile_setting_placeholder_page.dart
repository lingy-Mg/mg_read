...
_SettingCopy _copyFor(String settingId) => switch (settingId) {
  'reading-settings' => const _SettingCopy(
    title: '阅读设置',
    description: '字体、排版与翻页设置将在这里提供。',
  ),
  'downloads-cache' => const _SettingCopy(
    title: '下载与缓存',
    description: '下载任务与本地存储管理将在这里提供。',
  ),
  'theme-appearance' => const _SettingCopy(
    title: '主题与外观',
    description: '主题、显示与外观选项将在这里提供。',
  ),
  'privacy-permissions' => const _SettingCopy(
    title: '隐私与权限',
    description: '隐私说明与系统权限管理将在这里提供。',
  ),
  'data-backup' => const _SettingCopy(
    title: '数据备份与同步',
    description: '备份与跨设备同步将在这里提供。',
  ),
