...
final class ContentLibraryBookVisibilityChanger
    implements LibraryBookVisibilityChanger {
  ...
  Future<void> setBookVisibility(String bookId, LibraryVisibility visibility) =>
      _library.bookshelf.setVisibility(LibraryItemId(bookId), visibility);
}
