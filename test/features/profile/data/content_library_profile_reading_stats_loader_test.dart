...
void main() {
  test(
    'projects local shelf count, read books, and reading duration',
    () async {
      ...
      final readItem = await library.bookshelf.add(
        title: '已读书',
        ...
        source: const ContentLibraryIngest(
          ...
          dataVersion: 1,
          opaqueData: <String, Object?>{'remoteBookId': 'read'},
        ),
      );
      await library.bookshelf.add(
        ...
        source: const ContentLibraryIngest(
          ...
          producerPluginVersion: '1.0.0',
          dataVersion: 1,
          opaqueData: <String, Object?>{'remoteBookId': 'unread'},
        ),
      );
      ...
      final stats = await ContentLibraryProfileReadingStatsLoader(
        library,
      ).load();
