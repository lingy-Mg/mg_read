...
void main() {
  test(
    'loads the shelf once and answers same-source title checks in O(1)',
    () async {
      ...
      final container = ProviderContainer(
        overrides: [
          bookshelfMembershipLoaderProvider.overrideWithValue(loader),
        ],
      );
      ...
      expect(
        container
            ...
            .contains(pluginId: 'source.a', title: '诡秘 之主'),
        isTrue,
      );
      expect(
        container
            .read(bookshelfMembershipProvider)
            .contains(pluginId: 'source.b', title: '诡秘 之主'),
        isFalse,
      );
