...
test('fixture chain covers discovery, search, detail, complete gallery and resource proxy', async (t) => {
  ...
  const home = await plugin.discover({ target: null, cursor: null, collectionId: null, pageSize: 20 }); assert.equal(home.document.components[0].children[0].categories.length, 9);
