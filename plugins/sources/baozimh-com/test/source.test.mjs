...
test('fixtures cover categories search detail redirected catalog ordered pages and Referer proxy', async () => {
  ...
  const root = await plugin.discover({ target: null, cursor: null, collectionId: null, pageSize: 20 }); assert.equal(root.document.components[0].children[0].categories.length, 8);
