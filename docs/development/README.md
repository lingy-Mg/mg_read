...
| 全局动效、减少动态效果、共享过渡 | [workflow](workflow.md)、[全局动效设计系统](../implementation/global-motion-design-system.md) | [UI 系统](../implementation/ui-design-system.md)、相关 `app/`、`shared/` 实现与测试 |
...
| 日志、trace、关键链路、性能埋点 | [诊断接入规范](diagnostics-instrumentation.md)、[日志专题](../architecture/14-global-diagnostics-logging.md) | App 读 ADR-0016 与 `lib/core/diagnostics/README.md`；Runtime 读 ADR-0024 与 Debug 日志测试 |
